...
------------
Further adaptation to incorporate the seconf encoder.
...
class LSTMModelKnowldg(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        decoder = RRGenLSTMDecoder(
            ...
            # do I need to get encoder_output_units from encoder2?
            # naaaah, I need to combine them before passsing them tp the decoder
...
class RRGenLSTMDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        # added this. do I need it? dunno.
        use_knowl: bool = False,
        use_len: bool = False,
        ...
        if self.tie_ext_features:
            ...
            # I don't know if I need this here but added for now
            if self.use_knowl:
                self.tie_ext_feature_size += 1
            if self.use_len:
                self.tie_ext_feature_size += 1
...
def Embedding(num_embeddings, embedding_dim, padding_idx):
    ...
    # what is this here? what weights?
